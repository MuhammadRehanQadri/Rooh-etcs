...
export const OG_ALT = "ETCS — Where Vision Becomes Reality";

/**
 * The default social card, shared by `opengraph-image` and `twitter-image` so
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Expert Technical Contracting &amp; Services — industrial and
